...
globalkeys = gears.table.join(
    -- Launcher
    awful.key({ altkey }, " ", function() awful.spawn(apps.rofi_run) end,
        { description = "Rofi open app", group = "launcher" }),
    awful.key({ modkey, }, "Return", function() awful.spawn(apps.terminal) end,
        { description = "open a terminal", group = "launcher" }),

    -- Lock screen
    awful.key({ modkey }, "p", function() awful.spawn(apps.lock) end,
        { description = "Lock screen", group = "System" }),
    -- Power options
    awful.key({ modkey }, "Escape", function() awful.spawn.with_shell(apps.rofi_power) end,
        { description = "Rofi power options", group = "System" }),
    -- Xrandr
